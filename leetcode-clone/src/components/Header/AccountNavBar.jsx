...
const AccountNavbar = ({ colour, hoverColour }) => {
  return (
    <header className={`text-gray-600 body-font px-48 py-3 ${colour}`}>
      <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 flex flex-wrap items-center text-base justify-center">
          <Link className={`mr-5 text-gray-400 hover:cursor-pointer hover:text-${hoverColour} transform ease-out duration-700`} href="">
            Explore
          </Link>
          <Link className={`mr-5 text-gray-400 hover:cursor-pointer hover:text-${hoverColour} transform ease-out duration-700`} href="">
            Problems
