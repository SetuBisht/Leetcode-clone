            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow lg:w-2/4 md:w-1/2 lg:pl-80 md:pl-16 flex flex-col md:items-start md:text-left justify-center items-center text-center">
                        <h1 className="title-font sm:text-5xl text-3xl mb-4 font-medium text-white">A New Way to Learn</h1>
                        <p className="mb-8 text-gray-400 leading-relaxed">
                            {firstSentenceCharacters.slice(0, firstSentenceIndex + 1).join('')}
                        </p>
                        <div className="flex justify-center">
                            <button
                                className="inline-flex text-base rounded-[20px] text-white bg-orange-500 border-0 py-2 px-4 focus:outline-none hover:bg-lime-600 transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out"
                                onClick={() => {
            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow lg:items-end md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start mb-16 md:mb-0 items-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-orange-500">Start Exploring</h1>
                        <p className="text-right opacity-50 mb-8 leading-relaxed">
                            {secondSentenceCharacters.slice(0, secondSentenceIndex + 1).join('')}
                        </p>
                        <div className="flex justify-center">
                            
                            <button className="inline-flex text-base rounded-[20px] text-white bg-orange-500 border-0 py-2 px-4 focus:outline-none hover:bg-lime-600 transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
                                Get Started
                            </button>
                        </div>
                    </div>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className={`flex flex-wrap w-full mb-20 ${isVisible ? "opacity-100 transition-opacity duration-2000" : "opacity-0 transition-opacity duration-500"}`}>
                        ...
                        <div className="w-1 h-36 m-5 bg-orange-300"></div>
                    ...
                    <div className={`flex flex-wrap -m-4 transform transition-transform ${isVisible ? 'translate-x-0 duration-2000' : '-translate-x-full duration-2000'}`}>
                        {[{ title: "PYTHON" }, { title: "JAVA" }, { title: "JAVASCRIPT" }, { title: "C" }].map((item, idx) => (
                            <div key={idx} className="xl:w-1/4 md:w-1/2 p-4 transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
                                <div className="bg-gray-100 p-6 rounded-lg">
                                    {/* <Image className="h-40 rounded w-full object-cover object-center mb-6" src={Me} alt="content" /> */}
                                    <h2 className="tracking-widest text-indigo-500 text-lg font-medium title-font">{item.title}</h2>
            ...
            <section className="text-white body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <p className="leading-relaxed text-base">If you are passionate about tackling some of the most interesting problems around, we would love to hear from you.</p>
